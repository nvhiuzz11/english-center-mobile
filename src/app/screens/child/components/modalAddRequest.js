...
export const ModalAddRequest = props => {
  ...
  const onPress = () => {
    if (!childId || isOnlyWhitespace(childId) || isNaN(childId)) {
  ...
  return (
    <Modal
      ...
      <Layout style={styles.container}>
        ...
        <Text style={styles.header}>{translate('Add student')}</Text>
        <View style={styles.inputContainer}>
          <Text style={styles.label}>{translate('Enter the student id')}:</Text>
          <InputApp
            style={styles.input}
            value={childId}
