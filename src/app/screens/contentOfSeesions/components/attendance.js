...
export const Attendance = props => {
  ...
  const renderItem = ({item, index}) => {
    return (
      <TouchableOpacity
        ...
        onPress={() => {
          navigation.navigate(SCREEN_NAME.ATTENDANCE, {
            payload: {
              type: ATTENDANCE_TYPE.UPDATE,
              classData: classData,
              attendanceData: item,
            },
          });
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        data={listAttendance ? listAttendance : []}
      ...
      <TouchableOpacity
        ...
        <Text style={styles.buttonTitle}>{translate('Add attendance')}</Text>
      </TouchableOpacity>
    </View>
  );
};
